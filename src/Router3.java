...
public class Router3 extends Node{
    char app;
...
//                    }
        ...
        public static void main(String[] args) {
            try{
                (new Router3(ROUTER3_PORT)).start();
            } catch (Exception e){
                e.printStackTrace();
            }
        }
        ...
        public synchronized void sendHello() throws IOException {
            ...
            DatagramPacket packet = new HelloPack("Hello sent from router3").toDatagramPacket();
    ...
    public void getRelevantRoutingTable() throws IOException {
        ...
        //RequestRoutingTable rrt = new RequestRoutingTable("router3");
        //System.out.println("NODE BEFORE GOING IN " + rrt.node);
        DatagramPacket routingTableRequest = new RequestRoutingTable("router3").toDatagramPacket();
